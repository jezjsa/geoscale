      ...
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-base font-semibold flex items-center gap-2">
                    <svg className="w-5 h-5 text-[var(--brand-dark)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    Your Selected Plan
                  </CardTitle>
                  <Link to="/plans" className="text-sm text-[var(--brand-dark)] hover:underline font-medium">
                    Change Plan
                  </Link>
                </div>
              </CardHeader>
          ...
          {/* <Card>
            ...
            <CardContent>
              <div className="flex gap-2">
                ...
                <Button type="button" variant="outline" className="bg-[var(--brand-dark)] text-white hover:bg-[#005030]">
                  Apply
                </Button>
              </div>
          ...
          <p className="text-sm text-center text-muted-foreground">
            ...
            <Link to="/login" className="text-[var(--brand-dark)] hover:underline font-medium">
              Sign In
            </Link>
          </p>
          ...
          {/* Back to Home Link */}
          <p className="text-sm text-center text-muted-foreground">
            <Link to="/" className="text-[var(--brand-dark)] hover:underline font-medium">
              ← Back to Home
            </Link>
          </p>
        </form>
